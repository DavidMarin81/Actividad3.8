...
public class MainA3_8 {
	...
	public static void main(String[] args) {
		...
		//Método del apartado 3.C
		//crearComunidadYProvincias2(session);
		
		//eliminarComunidad(session, 19); // borrado de Melilla como CA
		//eliminarProvinciaDeComunidad(session, 100);
		
		//Método del apartado 4.C
		eliminarProvinciaDeComunidad2(session, 120);
		session.close();
	...
	private static void crearComunidadYProvincias2(Session session) {
		...
		try {
			...
			int idCA = 120;
			ComunidadAutonoma ca = new ComunidadAutonoma();
			ca.setNombre("Nueva CA2");
			// El id no se asigna automáticamente en esta tabla
			ca.setIdCa(idCA);

			Provincia prov1 = new Provincia();
			prov1.setNombre("Nueva prov 2.1");
			// El id no se asigna automáticamente en esta tabla
			prov1.setIdProvincia(idCA + 1);

			Provincia prov2 = new Provincia();
			prov2.setNombre("Nueva prov 2.2");
			// El id no se asigna automáticamente en esta tabla
			prov2.setIdProvincia(idCA + 2);

			
			// Añadimos todos los valores a provincia, para que tenga idCa
			prov1.setComunidadAutonoma(ca);
			prov2.setComunidadAutonoma(ca);
			
			//Añadimos las provincias a la CA
	...
	private static void eliminarProvinciaDeComunidad2(Session session, int idCA) {
